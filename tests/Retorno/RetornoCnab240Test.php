...
use Kspotx\LaravelBoleto\Cnab\Retorno\Cnab240\Detalhe;
use Kspotx\LaravelBoleto\Cnab\Retorno\Cnab240\DetalheSegmentoT;
use Kspotx\LaravelBoleto\Cnab\Retorno\Cnab240\DetalheSegmentoU;
use Kspotx\LaravelBoleto\Cnab\Retorno\Cnab240\DetalheSegmentoY;
...
class RetornoCnab240Test extends TestCase
{
    ...
    {
        $retorno = \Kspotx\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab240/santander.ret');
        $retorno->processar();
